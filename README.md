...
## 2일차
- 기초 문법
    - 리스트 컴프리헨션 복습 : [주피터노트북](./day02/da01_list_again.ipynb)

- 자료구조
    - 선형 리스트 : [주피터노트북](./day02/da02_linear_list.ipynb)
    - 연결 리스트 : [주피터노트북](./day02/da04_linked_list.ipynb)
...
- 자료구조
    ...
    - 스택 : [주피터노트북](./day03/da02_stack.ipynb)
        - 개념, 주피터노트북 참조
        - 알고리즘 DFS(깊이우선탐색) 시 사용
        - 스택 구현 : [파이썬](./day03/da03_stack.py)
    - 큐 : [주피터노트북](./day03/da04_queue.ipynb)
        - 개념, 주피터노트북 참조
...
- 자료구조/알고리즘
    ...
    - 이진트리 : [주피터노트북](./day04/da02_binary_tree.ipynb)
...
## 5일차
- 자료구조/알고리즘
    - 그래프 : [주피터노트북](./day05/da01_graph.ipynb)
        - 깊이우선탐색 : [파이썬](./day05/da02_dfs.py)
        - 최소비용 신장트리 : [파이썬](./day05/da03_min_cost_spanningtree.py)
    
    - 재귀호출 : [주피터노트북](./day05/da04_recursive_call.ipynb)

## 6일차
- 자료구조/알고리즘
    - 재귀호출
        - 재귀호출 연습 : [주피터노트북](./day06/da01_recursive_practice.ipynb)
        - 프랙탈 연습

https://github.com/user-attachments/assets/d040fc63-a047-4cb4-9289-5122e659ce55

- 자료구조/알고리즘
    - 정렬 : [주피터노트북](./day06/da04_sort.ipynb)
